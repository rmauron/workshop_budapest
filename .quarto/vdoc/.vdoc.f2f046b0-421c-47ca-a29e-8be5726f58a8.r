...
annot <- gtf[gtf$type %in% c("gene", "transcript")] |>
  mcols() |>
  as.data.frame() |>
  dplyr::select(gene_id, gene_name, gene_type, transcript_id, transcript_name,transcript_type) |>
  dplyr::distinct()
...
saveRDS(annot, "data/annotation/GRCh38-2020-A_gene_biotypes.rds")
#
#
#
#
